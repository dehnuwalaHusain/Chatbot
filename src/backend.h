...
Dictionary* initialize_vocabulary ()	{
	...
	sets [ 1 ].responses [ 2 ] = "Processing erraneous inputs by lower mortals, how about you?\n";
...
std::string categorize ( std::string userQuery )	{
	...
	else if (( userQuery.find ( "WHO" ) != std::string::npos) && 
